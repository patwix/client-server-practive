...
/** Le client doit tre capable de lire un fichier texte et dÕenvoyer son contenu au serveur qui retransmettra aussitt
 *  son contenu au client. Ce dernier devra intercepter le contenu du fichier texte.
 *  Une fois la rception termine, le serveur devra inverser le contenu du fichier de sorte 
 *  ce que la premire ligne reue soit la dernire ligne envoye vers le client. **/
...
public class Client {
    ...
    public static void main(String[] args) throws UnknownHostException, IOException, ClassNotFoundException {
        ...
        String serverIpAddress = new Scanner(System.in).nextLine();

        System.out.println("Server address: " + serverIpAddress);
